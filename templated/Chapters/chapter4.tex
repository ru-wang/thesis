...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.45\textwidth]{Pictures/cubic_ceres.png}
    \includegraphics[width=.45\textwidth]{Pictures/cubic_spec3.png}
    \caption{数据集Cubic-50运行结果：左图为Ceres-LM求解所得的点云，右图为HMLDL求解所得的点云}
    \label{fig:cubic}
\end{figure}

\begin{figure}[htb!]
    \centering
    \includegraphics[width=.45\textwidth]{Pictures/venice_ceres.png}
    \includegraphics[width=.45\textwidth]{Pictures/venice_spec3.png}
    \caption{数据集Venice-51运行结果：左图为Ceres-LM求解所得的点云，右图为HMLDL求解所得的点云}
    \label{fig:venice}
\end{figure}
