...
\begin{figure}[htb!]
    \centering
    \includegraphics[scale=1]{figs/sqrt_info.png}
    \caption{平方根信息矩阵}
\end{figure}

\begin{figure}[htb!]
    \centering
    \includegraphics[scale=.7]{figs/factor_graph_elim.png}
    \caption{消元}
\end{figure}

\begin{figure}[htb!]
    \centering
    \includegraphics[scale=.8]{figs/bayes_tree.png}
    \caption{贝叶斯树}
\end{figure}
